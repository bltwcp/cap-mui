import { Typography as MuiTypography, MenuItem as MuiMenuItem, Button as MuiButton, Tabs as MuiTabs, Tab as MuiTab, Input as MuiInput, FormControl as MuiFormControl, FormControlLabel as MuiFormControlLabel, Box as MuiBox, Autocomplete as MuiAutocomplete, TextField as MuiTextField, Checkbox as MuiCheckbox, LinearProgress as MuiLinearProgress, Select as MuiSelect, InputLabel as MuiInputLabel, styled, lighten, darken, } from '@mui/material';
const fontSize = '13px';
...
`;
export const StyledMultiMuiSelect = styled((MuiSelect)) `
    font-size: ${fontSize};
    textAlign: left;
    border: 0px;
    width: 100px;
