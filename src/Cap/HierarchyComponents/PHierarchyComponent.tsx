import { HierarchyItemInterface, usePHierarchy, usePHierarchyItem, usePHContext, } from './useHierarchy'
...
export const PHierarchyComponent = (props: HierarchyBaseComponentProps) => {
    const dialog = (selected: HierarchyItemInterface[], showDialog: boolean, handleCloseSelectDialog: () => void, handleDialogInput: (items: HierarchyItemInterface[]) => void) => {
        return <HierarchyBaseDialog
            ...
            useHierarchyContext={usePHContext}
            useHierarchy={usePHierarchy}
            useHierarchyItem={usePHierarchyItem}
